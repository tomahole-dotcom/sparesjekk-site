...
for rel in PAGES:
 ...
 bar=s.new_tag('aside'); bar['data-revenue-sticky']='v1'; bar['class']=['revenue-sticky']; bar['aria-label']='Neste steg'; bar['hidden']=''
 ...
 # Do not ship a placeholder external link: QA treats every sponsored link as a real affiliate URL.
 a=s.new_tag('a'); a['class']=['revenue-sticky-cta']; a['href']='#partneralternativer'; a['data-revenue-event']='sticky_partner_click'; a['data-revenue-stage']='partner_outclick'; a['target']='_blank'; a.string='Gå videre →'; bar.append(a)
