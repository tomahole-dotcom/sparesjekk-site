...
add('guide-effektiv-nominell-rente.html','nominal-effective-v1','Nominell rente vs. effektiv rente – kort svar','Nominell rente er selve rentesatsen. Effektiv rente inkluderer relevante kostnader i beregningen og er derfor normalt det bedre sammenligningstallet når du vurderer konkrete lånetilbud med like forutsetninger.',[('hva-er-effektiv-rente.html','Les mer om effektiv rente'),('boliglanskalkulator-renteforskjell.html','Gjør en renteforskjell om til kroner'),('guide-sammenligne-boliglan.html','Sammenlign boliglån på like vilkår')])
