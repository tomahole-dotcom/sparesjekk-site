...
existing=s.select_one('[data-consumer-early-intent="v1"]')
if existing: existing.extract()
...
first=s.find('section',attrs={'data-consumer-authority':'definition-v1'}) or sec.find_next_sibling('section')
